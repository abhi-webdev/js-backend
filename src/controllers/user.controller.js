...
const updateAccountDetails = asyncHandler (async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, user, "Account details and update Successfully"))
})
...
const updateUserCoverImage = asyncHandler(async(req, res) =>{
    ...
    return res.status(200).json(new ApiResponse(200, user, "Cover image update succesfully"))
})
